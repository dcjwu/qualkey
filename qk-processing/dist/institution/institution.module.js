...
const institution_repository_1 = require("./repository/institution.repository");
let InstitutionModule = class InstitutionModule {
};
InstitutionModule = __decorate([
    (0, common_1.Module)({
        exports: [institution_repository_1.InstitutionRepository],
        providers: [institution_repository_1.InstitutionRepository],
    })
], InstitutionModule);
