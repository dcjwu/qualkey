...
let InstitutionRepository = class InstitutionRepository {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async getByUuid(uuid) {
        ...
        if (null === institution)
            throw new exception_1.InstitutionNotFoundException(uuid);
        return institution;
    }
    async getByUuidWithRepresentatives(uuid) {
...
InstitutionRepository = __decorate([
