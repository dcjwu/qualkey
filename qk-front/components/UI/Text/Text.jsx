...
const Text = ({ blue, lightBlue, grey, white, small, medium, large, underline, link, error, success, bold, semiBold, sidebar, sidebarMin, active, blackSpan, children, ...otherProps }) => {
   if (link) return (
      <Link href={link}>
